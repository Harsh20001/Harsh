...
WebUI.setText(findTestObject('Page_Laser Audit Reporting System/input_Username'), 'admin')

WebUI.setEncryptedText(findTestObject('Page_Laser Audit Reporting System/input_Password'), 'J7R4ejOak4Y=')
